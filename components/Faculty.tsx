    ...
    <Center py={12} mx={20} mt={20}>
        ...
        <Box
            ...
            <Stack pt={10} align={'center'}>
                <Heading fontSize={'2xl'} fontFamily={'body'} fontWeight={700} color={useColorModeValue('blue.700','blue.400')}>
                 {name}
                </Heading>
...
const faculty = [
    {
        ...
        imgurl: "images/faculty/pontest.png",
    ...
    },
    {
        ...
        imgurl: "images/faculty/abha.png",
...
export default function FacultySection() {
    ...
    return (
        <Box p={4} id='Faculty'>
            ...
            <Flex p={5} flexWrap={'wrap'} justify={'center'}>
                {
                    faculty.map((fac) => {
                        let skill_issue = 
                        <>
